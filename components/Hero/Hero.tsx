  ...
  return (
    <div className="relative flex items-center text-black overflow-hidden flex-col mt-50 ">
      <div className="relative flex flex-col items-center">
        ...
        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl mt-6 text-center font-bold tracking-wide z-[-1999]">
          Say Bye Bye to Junk <br /> Fast, Local, Affordable.
        </h1>
        <h2 className="mt-5 text-sm px-2 text-center sm-text-2xl font-medium flex items-center z-[-1999]">
